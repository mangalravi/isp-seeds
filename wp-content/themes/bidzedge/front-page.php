...
<header class="fixed-top nvbrhdr bg-white">
      <nav class="navbar navbar-expand-xl justify-content-center bdrbtm">
        <div class="container justify-content-center">
          <div class="row justify-content-between w-100 align-items-center">
            <div
              class="col-xl-2 d-flex justify-content-between align-items-center"
            >
            ...
            <div class="col-9">
              <div
                class="collapse navbar-collapse justify-content-between pt-4 pt-xl-0"
              ...
              >
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a href="#Contact" class="nav-link me-0">Contact</a>
                  </li>
                </ul>
      ...
      <div class="container">
        <div class="row justify-content-center text-center">
          <div class="col-md-9 mb-4 mb-md-0">
            ...
            <div class="btmimg justify-content-center d-none d-md-block">
              <div class="row gx-5">
                <div class="col-4">
          <img src="<?php echo get_template_directory_uri(); ?>/content/images/banner-1.png" alt="one" />
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/content/images/banner-img.png" alt="banner" class="d-block d-md-none p-4"/>
        </div>
      </div>
    </section>
    ...
    <section class="why-bidzedge" id="Bidzedge">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-9">
            <div class="sec-tpcntnt mb-0 mb-md-5">
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-4 mb-0 mb-md-5 d-flex">
                <div class="sec-card">
        ...
        <p class="lstwhy m-0">
        Approx <span class="lst"> 15+</span> team members ready to support you online
        </p>
      </div>
    </section>

    <section class="features  pb-md-0" id="Features">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-9">
            <div class="sec-tpcntnt mb-0">
              <h4 class="sec-head">Features</h4>
              <p class="sec-para mb-0">
    ...
    <section class="about position-relative overflow-x-hidden" id="About">
      <div class="container">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-9 col-lg-6">
            <div class="sec-tpcntnt mb-3 m-md-0">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="slide-inner">
                ...
                <div class="slidecntn">
                  <div class="slideimg">
                    <img src="<?php echo get_template_directory_uri(); ?>/content/images/mr-sambhav-garg.webp" alt="user1" />
                  </div>
                  <div class="rgtsldcnt">
                    <h6>Mr. Sambhav Garg</h6>
                    <p>Inventive Grassland Pvt. Ltd.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="slide-inner">
                ...
                <div class="slidecntn">
                  <div class="slideimg">
                    <img src="<?php echo get_template_directory_uri(); ?>/content/images/mr-suneel-kr-gupta.webp" alt="user2" />
                  </div>
                  <div class="rgtsldcnt">
                    <h6>Mr. Suneel Kr. Gupta</h6>
                    <p>Inventive Software Solutions Pvt. Ltd.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="slide-inner">
                ...
                <div class="slidecntn">
                  <div class="slideimg">
                    <img src="<?php echo get_template_directory_uri(); ?>/content/images/mr-prashant-pacheriwala.webp" alt="user3" />
                  </div>
                  <div class="rgtsldcnt">
                    <h6>Mr. Prashant Pacheriwala</h6>
                    <p>Haldhari Farms Pvt. Ltd.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              ...
              <p>
                ...
                <div class="slidecntn">
                  <div class="slideimg">
                    <img src="<?php echo get_template_directory_uri(); ?>/content/images/Sanjay Agrawal(QC Head).jpg" alt="user1" />
                  </div>
                  <div class="rgtsldcnt">
                    <h6>Mr. Sanjay Agrawal</h6>
                    <p>Inventive Software Solutions Pvt. Ltd.</p>
                  </div>
                </div>
              </div>
                  ...
                  >
                    <div class="row justify-content-center">
                      <div class="col-9 col-md-12">
                        <div class="row ">
                        <div class="col-sm-6 col-xl-4 d-flex mb-4 mb-xl-0">
                        <div class="tabcard">
    ...
    <section class="contact" id="Contact">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-11 col-lg-6 mb-lg-4">
