...
<html lang="en">
  <head>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/content/lib/Select2/select2.min.css" />
            ...
            <div class="signhdr">
              ...
              <div class="row justify-content-center">
                <div class="col-sm-8 col-md-12 col-lg-7">
                  <div class="mb-3 fstform pt-5">
                    <div class="sgnhd">
                      <h6 class="mb-1">Sign Up For Free</h6>
                      <p>WelCome Bidzedge !</p>
                    </div>
                    <!--form-->
                    <div id="form1" class="mb-0 mb-md-5">


                    <p id="paraalreadyexist"  class="user-label required paraalreadyexist"> </p>


                    <div class="mb-3">
                      <div class="input-group mb-2">
                      <input required="" type="text" name="companydomain" id="companydomain" />
                    ...
                    <div class="mb-3">
                      ...
                      <!-- <p id="CompanyNameCheck">Field Required</p> -->
                    </div>
                    <div class="mb-3">
                      <div class="input-group mb-2">
                      <input required="" type="text" name="contact_person" id="contact_person" />
                    ...
                    <div class="mb-3">
                      <div class="input-group mb-2">
                      <input required="" type="number" name="contact_number"  id="contact_number"
                    ...
                    <div class="mb-3">
                      <div class="input-group mb-2">
                      <input required="" type="email" name="contact_email"  id="contact_email" class="mandatory email" />
                      <label class="user-label required">Email ID</label>
</div>
                      <!-- <p id="emailvalid" > Field Required </p> -->
                    </div>
                    <div class="trmcnd">
                  ...
                  <button type="submit"  class="btn btn-tender-primary w-100 mb-4 fw-bold nextbtn" >Register</button>
