...
$(document).ready(function () {
  ...
  $(".nextbtn").click(function () {
    ...
    isFormValid = isFormValid && validateCompanyDomain();
    isFormValid = isFormValid && validateCompanyName();
    isFormValid = isFormValid && validateCompanySize();
    isFormValid = isFormValid && validateContactPerson();
    isFormValid = isFormValid && validateEmail();
    isFormValid = isFormValid && validateMobileNumber();
