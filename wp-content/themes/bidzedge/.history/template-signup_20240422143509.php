...
?>
                     ...
                     <div class="mb-3 position-relative">
                      ...
                      <label class="user-label required">Company Size</label>
                      </div>
                      <span id="companySizecheck">Field Required</span>
                    </div>
                    <div class="row">
                      <div class="col-5">
                        <a
                      ...
                      <div class="col-7">
                      <button type="submit" name="submit" class="btn btn-primary w-100 mb-4 fw-bold submitbtn">Submit</button>
        ...
        <div class="col-md-6 d-none d-md-flex flex-column lftslidercol">
          <div class="lftslider">
