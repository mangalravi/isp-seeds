...
<script>
    ...
    "companydomain": "amarujala.com",
    "contact_person": "SUNEEL",
    "contact_email": "MEGHA.A@INVENTIA.IN",
            ...
            <div class="signhdr">
              ...
              <div class="row justify-content-center h-100">
                <div class="col-sm-8 col-md-12 col-lg-8 d-flex align-items-center justify-content-center">
                  <form class="mb-5 mb-md-3 w-100 regfrm" method="post" action="" name="registration">
                  <div class="fstform">
                    <div class="sgnhd">
                  ...
                  <div class="sgnhd">
                    ...
                    <div class="form-group floating-diff mb-4 aftrarr">
...
?>
                    ...
                    <div class="form-group floating-diff mb-4">
                      ...
                      <option value="5">1000-50000</option>
