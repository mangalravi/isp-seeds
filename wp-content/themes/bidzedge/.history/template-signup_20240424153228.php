            ...
            <div class="signhdr">
              ...
              <div class="row justify-content-center">
                <div class="col-sm-8 col-md-12 col-lg-7">
                  ...
                  <button type="submit" name="submit" class="btn btn-tender-primary w-100 mb-4 fw-bold">Registred</button>
...
?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-7">
                      <button type="submit" name="submit" class="btn btn-tender-primary w-100 mb-4 fw-bold">Submit</button>
