...
echo'<script>window.location.href="http://localhost:8080/bidzedge/thankyou/";</script>';
}
?>
...
?>
                    ...
                    <a href="/thankyou" type="submit" name="submit" class="btn btn-tender-primary w-100 mb-4 fw-bold submitbtn">Submit</a>
                    <a href="/thankyou" class="lnkpara">
                    Skip this Step
                  </a>
