                ...
                <div class="col-sm-8 col-md-12 col-lg-8">
                  <div class="fstform">
                    ...
                    <div class="mb-2">
                      ...
                      <span id="CompanyNameCheck">Please enter Company Name</span>
                    </div>
                    <div class="mb-2">
                      <div class="input-group">
                      ...
                      <span id="passperson">Please enter Contact Person Name</span>
                    </div>
                    <div class="mb-2">
                      <div class="input-group">
                      ...
                      <span id="passcheck">Please enter Mobile number </span>
                    </div>
                    <div class="mb-3">
                      <div class="input-group">
                      ...
                      <span id="emailvalid" class="form-text text-muted invalid-feedback">Please enter Email ID  </span>
                    </div>
                    <div class="trmcnd">
