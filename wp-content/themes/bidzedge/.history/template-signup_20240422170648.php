...
?>
                    ...
                    <div class="form-group floating-diff mb-4 focused">
                      <label class="floating-label user-label">Company Size</label>
                      <select name="company_type" class="form-control floating-control">

                      <option value=""> Choose Company Size</option>
                      <option value="1">Private Limited Company</option><option value="2">Public Limited Company</option><option value="3">Partnerships Company</option><option value="4">Limited Liability Partnership</option><option value="5">One Person Company</option><option value="6">Sole Proprietorship</option>
                      </select>
                    </div>
                    <a href="/thanku" type="submit" name="submit" class="btn btn-tender-primary w-100 mb-4 fw-bold submitbtn">Submit</a>
                    <a href="/thanku" class="lnkpara">
                    Skip this Step
                  </a>
