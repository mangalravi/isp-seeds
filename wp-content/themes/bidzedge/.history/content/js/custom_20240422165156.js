  ...
  $(".floating-control").on("change focus blur", function (e) {
    if ($(this).is("select")) {
      if (
        ...
        $(this).parents(".floating-diff > select").addClass("focused");
      } else {
        $(this).parents(".floating-diff > select").removeClass("focused");
      }
    }
  });
});
...
$(document).ready(function () {
  ...
  //       if (CompanySizeValue.trim() === "") {
  //         $("#companySizecheck").show();
  //         return false;
  //       } else if (CompanySizeValue.length < 1 || CompanySizeValue.length > 10) {
  //         $("#companySizecheck").show();
  //         return false;
  //       } else {
  //         $("#companySizecheck").hide();
  ...
  //     let isCompanySizeValid = validateCompanySize();

  //     // If company size is not valid, prevent form submission
  //     if (!isCompanySizeValid) {
  //       // Optionally, you can display an error message or perform other actions
  //       console.log("Company Size is not valid.");
  //     } else {
  //       // If company size is valid, you can proceed with form submission
  //       // Example:
  //       // $(".your-form").submit();
  //     }
  //   });
